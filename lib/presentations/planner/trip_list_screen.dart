...
class _TripListScreenState extends State<TripListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final selectedTrip =
        allTrips.isNotEmpty ? allTrips[_selectedIndex] : null;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: GoogleFonts.plusJakartaSans(
                                fontSize:
                                    t.shortDateLabel.length > 3 ? 12 : 17,
                                fontWeight: FontWeight.w800,
                                color: isSelected
                                    ? Colors.white
                                    : isPast
                  ...
                  children: [
                    Row(children: [
                      Container(
                        ...
                        child: Text(trip.shortDateLabel,
                            style: GoogleFonts.plusJakartaSans(
                                fontSize: 11,
                                fontWeight: FontWeight.w800,
                                color: isPast
          ...
          if (trip.activities.isEmpty)
            Container(
              ...
              child: Column(children: [
                ...
                const SizedBox(height: 8),
                Text('Ngày này chưa có hoạt động',
                    style: GoogleFonts.plusJakartaSans(
                        color: Colors.grey.shade500,
                        fontWeight: FontWeight.w600)),
              ]),
                        ...
                        Container(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: AppColors.warmCream, width: 2),
                            ),
                          ),
                        ),
                        // Card hoạt động
